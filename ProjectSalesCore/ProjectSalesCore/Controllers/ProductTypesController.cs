...
namespace ProjectSalesCore.Controllers
{
    public class ProductTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdProductType,TypeName")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdProductType,TypeName")] ProductType productType)
        {
            if (ModelState.IsValid)
            {

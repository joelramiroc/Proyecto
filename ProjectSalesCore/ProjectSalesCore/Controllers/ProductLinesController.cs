...
namespace ProjectSalesCore.Controllers
{
    public class ProductLinesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdProductLine,LineName")] ProductLine productLine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdProductLine,LineName")] ProductLine productLine)
        {
            if (ModelState.IsValid)
            {
